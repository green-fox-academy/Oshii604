...
app.listen(3000, () => {
  console.log('someones listening');
});
...
app.get('/', (req, res) => {
  ...
  if (req.query.alcohol !== undefined) {
    const filteredAlcohols = cocktails.filter((value) => value.contains.includes(req.query.alcohol));
    alcoholsObj.cocktails = filteredAlcohols;
  }
  res.render('home', alcoholsObj);
});
